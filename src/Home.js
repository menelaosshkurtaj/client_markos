...
<div style={{ width: '90%', margin: '0 auto', overflow: 'hidden', height: window.innerWidth <= 767 ? '100px' : '500px' }}>
...
<div className="row mb-4">
  <div className="col-md-6">
    ...
    <p>Στο συνεργείο ελαιοχρωματισμού Μάρκος Σκούρτης, το χρώμα είναι πολλά περισσότερα από μια απλή επιφανειακή εφαρμογή. Είναι η ψυχή που προσδίδει ζωή σε κάθε χώρο. Με περισσότερα από 20 χρόνια εμπειρίας στο χώρο, κατανοούμε την αξία της ποιότητας, της λεπτομέρειας και της ακρίβειας. Κάθε εργασία που αναλαμβάνουμε είναι μια αποτύπωση της αφοσίωσης και του πάθους μας για την τέχνη του ελαιοχρωματισμού. Επιλέγοντας το συνεργείο μας, επιλέγετε την ανωτερότητα, την εμπειρία και την εγγύηση μιας δουλειάς που θα αντέχει στον χρόνο.</p>
  </div>
  <div className="col-md-6">
